...
//
//	@GetMapping("/listar")
//	public ResponseEntity<List<Proof>> listar() {
//		List<Proof> listaProva = this.provaService.findAll();
//		return new ResponseEntity<>(listaProva, HttpStatus.OK);
//	}
//
//	@PutMapping("/updateProva/{id}")
//	public Proof updateProva(@RequestBody Proof prova, @PathVariable Long id) throws Exception {
